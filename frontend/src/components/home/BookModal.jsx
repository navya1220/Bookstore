  ...
  return (
    ...
    >
      <div
        ...
        className="w-[90%] sm:w-[600px] h-[90%] sm:h-[400px] bg-white rounded-xl p-4 flex flex-col relative overflow-auto"
      >
        <AiOutlineClose
        ...
        <p className="mt-4 text-sm md:text-base">Anything You want to show</p>
